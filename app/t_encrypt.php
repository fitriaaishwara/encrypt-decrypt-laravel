...
if (!function_exists('is_image_from_upload_file')) {
    // For check is input image or not
...
if (!function_exists('is_pdf_from_upload_file')) {
...
if (!function_exists('is_string_and_not_file_path')) {
    // for check is input pdf or not
...
if (!function_exists('split_encrypted_string')) {
...
if (!function_exists('base64_to_pdf')) {
...
if (!function_exists('write_to_txt_file')) {
